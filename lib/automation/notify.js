  ...
  return `
    <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#fff;">
      ...
      <div style="padding:28px 24px;">
        <h2 style="color:#3b0764;">Automation Review Required</h2>
        <p style="color:#555;">A new article has been generated and requires your approval:</p>
        <table cellpadding="12" style="background:#f0f2f5;border-radius:8px;border-left:3px solid #6d28d9;width:100%;margin-bottom:24px;">
          <tr><td>
            <p style="font-size:11px;color:#6b7a8d;text-transform:uppercase;margin:0 0 4px;">Article</p>
            <p style="font-size:16px;font-weight:bold;color:#3b0764;margin:0 0 4px;">${title}</p>
            <p style="font-size:13px;color:#6b7a8d;margin:0;">${category}</p>
          </td></tr>
        </table>
        <table width="100%"><tr>
          <td width="48%">
            <a href="${approveUrl}" style="display:block;text-align:center;background:#6d28d9;color:#fff;padding:14px;border-radius:6px;text-decoration:none;font-weight:bold;">✅ Approve &amp; Publish</a>
          </td>
          <td width="4%"></td>
          <td width="48%">
